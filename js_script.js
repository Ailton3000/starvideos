...
// ---------------------------------------------
const CATALOG = [
  { id: '00142', title: 'Arquitetura urbana — centro histórico', category: 'Documentário', videoId: 'aqz-KE-bpKQ' },
  { id: '00873', title: 'Receita: pão caseiro passo a passo', category: 'Culinária', videoId: 'aqz-KE-bpKQ' },
  { id: '01205', title: 'Trilha na Serra do Mar', category: 'Natureza', videoId: 'aqz-KE-bpKQ' },
  { id: '02291', title: 'Tutorial: introdução a CSS Grid', category: 'Educação', videoId: 'aqz-KE-bpKQ' },
  { id: '03017', title: 'Show acústico — noite de jazz', category: 'Música', videoId: 'aqz-KE-bpKQ' },
  { id: '04521', title: 'Entrevista: futuro das cidades inteligentes', category: 'Tecnologia', videoId: 'aqz-KE-bpKQ' },
];
...
function renderResult(id){
  ...
  if (found){
    const embed = found.videoId
      ? `<div class="video-embed"><iframe src="https://www.youtube.com/embed/${found.videoId}" title="${found.title}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>`
      : '';
    resultBox.innerHTML = `
      <div class="found">
        ${embed}
...
fGenerate.addEventListener('click', () => {
  ...
  const videoId = extractYouTubeId(fVideo.value.trim());
  ...
  const snippet = `  { id: '${id}', title: '${title}', category: '${category}', videoId: '${videoId}' },`;
...
function extractYouTubeId(value){
  ...
  // se não for um link reconhecido, assume que já é o ID puro
